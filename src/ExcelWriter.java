...
public class ExcelWriter {
    ...
    public static void writeToFile(java.nio.file.Path path, SeoUrl[] arraySeoUrls){
        ...
        try{
            ...
            System.out.println("ExcelWriter" + " writeToFile()" + ex);
            ...
            try {
                ...
                System.out.println("ExcelWriter" + " writeToFile() block finally" + ex);
                System.out.println(ex); //future logging
            }
            ...
            try{
                ...
                System.out.println("ExcelWriter" + " writeToFile() block try - try close workbook" + ex);
                System.out.println(ex); //future logging
            }
        }
